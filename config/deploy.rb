...
namespace :deploy do
  ...
  after :updating, :symlink do
    on roles(:app) do
      ...
      %w(achievements armoires outfits outfit_items bardings emotes relics hairstyles facewear spells achievement_items leve_items frames occult_records).each do |model|
